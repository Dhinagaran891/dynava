      ...
      <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
        ...
        <div>
          ...
          <h2 className="mt-5 text-4xl font-semibold tracking-[-0.045em] text-slate-950 sm:text-5xl">
            More useful when it connects to your business.
          </h2>
        </div>
        ...
        <div>
          <p className="text-lg leading-8 text-slate-600">
            A chatbot becomes significantly more valuable when it can work
            with the information and systems your organisation already uses.
          </p>
